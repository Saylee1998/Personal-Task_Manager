...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ActiveHighPriorityLimitException.class)
    public ResponseEntity<Map<String, Object>> handleActiveHighPriorityLimit(ActiveHighPriorityLimitException ex) {
